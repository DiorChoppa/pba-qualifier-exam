...
// 	fn provide_energy_with_efficiency(&self, f: FuelContainer<Uranium>, e: u8) -> <Uranium as Fuel>::Output {
// 		let efficiency = if e > 100 {
//             100
//         } else {
//             e
//         };

//         let efficiency_factor = efficiency as u64;
//         let output_joules = f.amount as u64 * 24000000000u64 * efficiency_factor / 100u64;

//         Joule(output_joules as u32)
// 	}
...
// impl<F: Uranium> ProvideEnergy<F> for NuclearReactor {
// 	fn provide_energy(&self, f: FuelContainer<F>) -> <F as Uranium>::Output {
